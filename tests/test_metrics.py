...
from topocheck import break_rate, build_units, label_with_tolerance
...
def test_label_with_tolerance_on_an_empty_prediction():
    from topocheck import label_with_tolerance
    lab = label_with_tolerance(np.zeros((12, 12), bool), tolerance=2)
    assert lab.sum() == 0
