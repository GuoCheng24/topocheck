...
def test_cross_splits_into_four_branches():
    g = np.zeros((40, 40), bool); g[20, 5:35] = True; g[10:30, 20] = True
...
def test_short_branches_dropped_by_min_size():
    ...
    g = np.zeros((30, 40), bool); g[10, 5:25] = True; g[20, 5:8] = True
...
def test_junction_removal_clears_the_whole_junction_neighbourhood():
    ...
    g = np.zeros((30, 30), bool); g[15, 5:25] = True; g[13:15, 12] = True
...
def test_works_in_3d():
    g = np.zeros((20, 20, 20), bool); g[10, 10, 3:17] = True
    u = build_units(g)
